...
public class ProjectService {
    ...
    public Project getProjectById(String id) { return projectInterface.getProjectById(id); }

    public Project getProjectByName(String name) { return projectInterface.getProjectByName(name); }
